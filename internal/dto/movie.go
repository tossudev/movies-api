...
type CreateMovieRequest struct {
	...
	GenreIDs    []int  `json:"genreIds,omitempty" validate:"dive,gt=0,unique"`
	ActorIDs    []int  `json:"actorIds,omitempty" validate:"dive,gt=0,unique"`
}
...
type UpdateMovieRequest struct {
	...
	GenreIDs    *[]int  `json:"genreIds,omitempty" validate:"omitempty,dive,gt=0,unique"`
	ActorIDs    *[]int  `json:"actorIds,omitempty" validate:"omitempty,dive,gt=0,unique"`
}
